...
import cabaniaPhotoIndoor2 from "../imgs/habitacion4Carrusel.jpg";
...
export const accommodation = [
    {
        slug: "complejo",
        title: "El Complejo",
        description: "Nuestro complejo vacacional está a la entrada de la ciudad de Mina Clavero, a 5 minutos del centro de la ciudad y los principales ríos de la misma. Contamos con 2 cabañas y 3 dormis para brindar el alojamiento que estás buscando",
    ...
    },
    {
        slug: "cabins", 
        title: "Cabañas",
        description: "En nuestras cabañas encontrarás una cocina-comedor equipada con frigobar y la vajilla necesaria para hasta cuatro personas. Además, cada cabaña cuenta con cochera individual, asador y un tender de ropa privado para mayor comodidad durante tu estadía.",
        informationText:"",
        services: [
            {img: carIcon, title:"Estacionamiento"},
            {img: wifiIcon, title:"Wifi"},
